...
interface AuthRemoteDataSource {
    ...
    @POST("auth/signin")
    suspend fun loginWithEmailAndPassword(@Body loginRequest: LoginRequest): retrofit2.Response<Res<UserEntity>>

    @POST("auth/signup")
    suspend fun registerWithEmailAndPassword(@Body registerRequest: RegisterRequest): retrofit2.Response<Res<UserEntity>>
