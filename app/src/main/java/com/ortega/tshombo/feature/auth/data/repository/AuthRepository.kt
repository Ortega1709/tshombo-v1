...
class AuthRepository @Inject constructor(
    ...
    override suspend fun loginWithEmailAndPassword(email: String, password: String): retrofit2.Response<Response<UserEntity>> {
    ...
    override suspend fun registerWithEmailAndPassword(
        ...
        password: String,
        email: String
    ): retrofit2.Response<Response<UserEntity>> {
